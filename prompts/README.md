...
| `document-worker-extractor-request-builder-v2.1-2026-09-07.txt` | complete review copy of the Extractor prompt-bearing Code node after client-confirmed field semantics alignment |
| `document-worker-validator-field-profiles-v1.1-2026-09-07.txt` | complete review copy of the Validator field-profile Code node after the same alignment |
